<head>
    <meta charset="UTF-8">
    <title> Clinica Oftalmologica </title>
    ...
    <link href="{{ asset('/EasyAutocomplete/easy-autocomplete.themes.min.css') }}" rel="stylesheet">  
    <link href="{{ asset('/plugins/select2.min.css') }}" rel="stylesheet">  
